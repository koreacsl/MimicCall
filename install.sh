...
LIBTRACEEVENT_TAG="libtraceevent-1.8.4"
echo "Checking out libtraceevent tag: ${LIBTRACEEVENT_TAG}"
git checkout "${LIBTRACEEVENT_TAG}" || error_exit "Failed to checkout libtraceevent tag ${LIBTRACEEVENT_TAG}"
