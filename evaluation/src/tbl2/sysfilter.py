...
FILTER_DIR = "./datasets/filters/sysfilter"
...
def load_sysfilter_syscalls(out_path):
    try:
    ...
    for binary in os.listdir(FILTER_DIR):
        ...
        for file in os.listdir(binary_dir):
            if file.endswith(".out"):
                syscall_set |= load_sysfilter_syscalls(os.path.join(binary_dir, file))
